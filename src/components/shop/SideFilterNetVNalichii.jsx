...
import NetVNalichiiProductCard from "../common/card/NetVNalichiiProductCard";
...
const SideFilterNetVNalichii = ({ allData, allFilter }) => {
            ...
            <div className="woocomerce__shopsidemain wc_feature_products">
              <div className="woocomerce__feature-wrapper filteringwrapper shopsidebar">
                {isLoading ? (
                  ...
                  filterData.map((el) => <NetVNalichiiProductCard el={el} key={el.id} />)
                ) : (
...
export default SideFilterNetVNalichii;
