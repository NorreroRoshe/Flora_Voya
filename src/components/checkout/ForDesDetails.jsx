            ...
            <div className="col-xxl-12 col-xl-12 col-lg-12 col-md-12">
              ...
              <h2 className="team__member-name-7">
                ...
                <h3 className="team__member-role-7">
                  <span>Стандартная доставка по Новой Риге</span>
                </h3>
                  {/* 300 ₽ */}
                  Бесплатно
                  <br/>
                ...
                <h3 className="team__member-role-7">
                  <span>Експресс доставка по Новой риге</span>
                </h3>
                  Бесплатно
                  {/* 350 ₽ */}
                <br/>
                <br/>
                  Доставка осуществляется день в день в случае если, заказ сделан до 13:00 с понедельника по субботу (Обратите внимание, что доставка может быть осуществлена ​​примерно до 22:00)
                  <br/>
                  <br/>
